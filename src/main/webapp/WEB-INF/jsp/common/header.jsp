    ...
    <div class="layui-container">
        ...
        <ul class="layui-nav fly-nav layui-hide-xs">
            ...
            <li class="layui-nav-item">
                <a href="${pageContext.request.contextPath}/case/case"><i class="iconfont icon-iconmingxinganli"></i>案例</a>
            </li>
            <li class="layui-nav-item">
        ...
        <c:choose>
            ...
            <li class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                ...
                <dd><a href="${pageContext.request.contextPath}/user/home"><i class="layui-icon" style="margin-left: 2px; font-size: 22px;">&#xe68e;</i>我的主页</a></dd>
